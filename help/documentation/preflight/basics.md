...
## Waar verschijnt Preflight

Preflight is beschikbaar in verschillende ontwerpomgevingen:

* **Universele Redacteur** - de Uitbreiding Preflight verschijnt in de **zijspoor**. Selecteer deze optie om een controle van de huidige pagina te starten.
...
1. Open de pagina die u wilt controleren in de ontwerpomgeving (Universal Editor, op document gebaseerde voorvertoning of AEM Sites Page Editor).
2. Open het deelvenster Preflight: selecteer de Preflight-extensie in de zijbalk of klik op de knop Preflight in Sidekick.
3. Preflight analyseert de pagina en geeft de mogelijkheden weer om de pagina te verbeteren.
