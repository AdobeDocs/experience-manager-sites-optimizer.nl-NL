...
Het GitHub auteurssysteem organiseert hiërarchisch meta-gegevens, gebruikend de volgende stijgende niveaus van precedent.
...
De metagegevens in de repo van `experience-manager-cloud-service.en` zijn het minimaal vereiste.
